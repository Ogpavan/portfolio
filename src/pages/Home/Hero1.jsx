...
function Hero1() {
  ...
  const [isWorkImageLoaded, setIsWorkImageLoaded] = useState(false);
            ...
            <div className="flex flex-col gap-y-4 w-full md:w-1/2">
              <div>
                <motion.div
                  ...
                  whileInView={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0, ease: "easeInOut" }}
                  className="bg-gradient-to-br from-[#222222] to-[#101010] rounded-3xl hover:shadow-[0_10px_30px_rgba(240,_46,_10,_0.2)] duration-300 space-y-1 cursor-pointer"
                >
                  <div>
                  ...
                  >
                    <div className="w-full flex justify-center p-6">
                      ...
                      <img
                        ...
                        alt="signature"
                        loading="lazy"
                        onLoad={() => setIsSignatureLoaded(true)}
                        className={isSignatureLoaded ? "block" : "hidden"}
                      />
                    </div>
                  ...
                  >
                    <div className="w-full flex justify-center p-6">
                      ...
                      <img
                        ...
                        alt="signature"
                        loading="lazy"
                        onLoad={() => setIsWorkImageLoaded(true)}
                        className={isWorkImageLoaded ? "block" : "hidden"}
                      />
                    </div>
