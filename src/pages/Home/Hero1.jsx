      ...
      <section className="  bg-[#0F0F0F]  ">
        <div className="max-w-[1170px] mx-auto">
          <div className="bg-[#0F0F0F] text-white/90 flex flex-wrap gap-y-4 gap-x-4  justify-center p-6 md:py-5 items-center  ">
            ...
            className="bg-gradient-to-br from-[#222222] to-[#101010]  rounded-3xl hover:shadow-[0_10px_30px_rgba(240,_46,_170,_0.3)] duration-300  px-16 w-full sm:w-auto py-6 space-y-1 h-80  flex justify-center items-center    ">
              <div>
                <p className="inter-tight-medium text-lg sm:text-xl text-[#BCBCBC]  ">
                  A WEB DEVELOPER
                </p>
                <h1 className="inter-tight-bold md:text-6xl text-5xl tracking-wide flex flex-col py-2 ">
                  <span>Pawan</span>
                  <span>Pal.</span>
                </h1>
